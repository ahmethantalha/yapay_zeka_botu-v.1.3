# src/presentation/views/simplified_settings.py (GÜNCELLENMİŞ)
...
class SimplifiedSettingsWindow(ctk.CTkToplevel):
    def __init__(self, parent):
        ...
        # Configure window
        self.title("API Ayarları")
        self.geometry("700x700")  # Daha büyük pencere
