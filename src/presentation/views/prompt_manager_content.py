# src/presentation/views/prompt_manager_content.py
...
class PromptManagerContent(ctk.CTkFrame):
    """Prompt şablonları yönetim içeriği"""
    ...
    def _show_template_dialog(self, name: str = "", description: str = "", template_text: str = ""):
        ...
        from .prompt_manager_window import TemplateDialog
        dialog = TemplateDialog(self.winfo_toplevel(), name, description, template_text)
